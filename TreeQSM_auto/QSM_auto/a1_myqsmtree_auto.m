...
% and be located in one folder in the QSM folder 
% You will need to change the trees_cloud_file 
...
% (how many trees point clouds are in your trees file)
tree_nums = 7;
...
% where is the name of tree point cloud file
% it should be in the same foulder as QSM
qsmtrees_name = 'QSM_Trees';
...
% name needed files
qsmfile = pwd;
qsmtrees = append(string(pwd), '\', qsmtrees_name);
outputfile = append(string(qsmtrees), '\', string(qsmtrees_name), '_QSM_output');
